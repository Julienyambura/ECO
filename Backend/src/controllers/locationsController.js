...
exports.getLocationById = exports.getLocations = void 0;
...
var getLocations = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Location_1.default.find().select("-__v -createdAt -updatedAt")];
            case 1:
                locations = _a.sent();
                res.json(locations);
                return [3 /*break*/, 3];
...
var getLocationById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, location_1, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Location_1.default.findById(id).select("-__v -createdAt -updatedAt")];
            case 1:
                location_1 = _a.sent();
                if (!location_1) {
